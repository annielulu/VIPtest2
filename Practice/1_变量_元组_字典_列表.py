...
# print(a.index(4))
#
# 练习：求列表[11,13,5,7,0,56,23,34,72]中的最大值、最小值及列表中一共有几个元素
...
# 2.不能通过下标引用
# 3.操作：
# 1)添加：s.add(n)--向集合s添加元素n
# s = {3,1,2}
# s.add('n')
# print(s)
# 2)删除：s.remove(n) -- 删除集合中的元素n，如果元素不存在，报keyerror异常
# 3)删除：discard（） --删除集合中的元素n
# 4)清空 - s.clear() -- 清空集合
